          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-dark o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">
<?php 
$jn=mysqli_query($con,"select * from geodata");
$pc=mysqli_num_rows($jn);
echo "ALL LOCATION DATA :  ".$pc;

?>
                </div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="view-loc.php">
                <span class="float-left">View Location</span>
                <span class="float-right">
                  <i class="fa fa-angle-right"></i>
                </span>
              </a>
